...
class DartHopper6LinkEnv(dart_env.DartEnv, utils.EzPickle):
    def __init__(self):
        ...
        self.net_modules.append([[2, 11], 1, [6]])
        self.net_modules.append([[3, 12], 1, [7]])
        self.net_modules.append([[4, 13], 1, [8]])
        self.net_modules.append([[5, 14], 1, [9]])
        self.net_modules.append([[6, 15], 1, [10]])
        self.net_modules.append([[7, 16], 1, [10]])
