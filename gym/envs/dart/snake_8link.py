...
class DartSnake8LinkEnv(dart_env.DartEnv, utils.EzPickle):
    def __init__(self):
        ...
        dart_env.DartEnv.__init__(self, 'snake_multilink/snake_8link.skel', 4, obs_dim, self.control_bounds, disableViewer=True)
        ...
        self.net_vf_modules.append([[], 5, [7]])

        # policy modules
        if not self.include_action_in_obs:
            self.net_modules.append([[8, 18], 1, None])
            self.net_modules.append([[7, 17], 1, [0]])
            ...
            self.net_modules.append([[8, 18, 25], 1, None])
            self.net_modules.append([[7, 17, 24], 1, [0]])
            self.net_modules.append([[6, 16, 23], 1, [1]])
            self.net_modules.append([[5, 15, 22], 1, [2]])
            self.net_modules.append([[4, 14, 21], 1, [3]])
            self.net_modules.append([[3, 13, 20], 1, [4]])
            self.net_modules.append([[2, 12, 19], 1, [5]])
        self.net_modules.append([[0, 1, 9, 10, 11], 0, [6]])

        self.net_modules.append([[], 6, [7, 6], None, False])
        self.net_modules.append([[], 6, [7, 5], None, False])
        self.net_modules.append([[], 6, [7, 4], None, False])
        self.net_modules.append([[], 6, [7, 3], None, False])
        self.net_modules.append([[], 6, [7, 2], None, False])
        self.net_modules.append([[], 6, [7, 1], None, False])
        self.net_modules.append([[], 6, [7, 0], None, False])
        ...
        # dynamic model # NEED TO BE FIXED
        self.dyn_enc_net = []
