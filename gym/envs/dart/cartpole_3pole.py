...
class DartCartPole3PoleEnv(dart_env.DartEnv, utils.EzPickle):
    def __init__(self):
        ...
        dart_env.DartEnv.__init__(self, 'cartpole_multilink/cartpole_3pole.skel', 2, obs_dim, self.control_bounds,
    ...
    def _step(self, a):
        ...
        reward = -np.linalg.norm(self.robot_skeleton.bodynodes[-1].C - np.array([0.6, 0.6, 0.0])) + 1.5
