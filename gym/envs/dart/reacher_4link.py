...
class DartReacher4LinkEnv(dart_env.DartEnv, utils.EzPickle):
    def __init__(self):
        ...
        dart_env.DartEnv.__init__(self, 'reacher_multilink/reacher_4link.skel', 4, 22, self.control_bounds, disableViewer=True)
    ...
    def initialize_articunet(self, reverse_order = None):
        ...
        self.net_vf_modules.append([[], None, [3], [16, 17, 18, 19, 20, 21]])
        ...
        self.net_modules.append([[], None, [3], [16, 17, 18, 19, 20, 21]])
        self.net_modules.append([[], None, [4], [16, 17, 18, 19, 20, 21]])
        self.net_modules.append([[], None, [5], [16, 17, 18, 19, 20, 21]])
        self.net_modules.append([[], None, [6], [16, 17, 18, 19, 20, 21]])
