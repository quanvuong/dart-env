...
class DartSnake4LinkEnv(dart_env.DartEnv, utils.EzPickle):
    def __init__(self):
        ...
        dart_env.DartEnv.__init__(self, 'snake_multilink/snake_4link.skel', 4, obs_dim, self.control_bounds, disableViewer=True)
