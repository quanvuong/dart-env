...
class DartSnake9LinkEnv(dart_env.DartEnv, utils.EzPickle):
    def __init__(self):
        ...
        dart_env.DartEnv.__init__(self, 'snake_multilink/snake_9link.skel', 4, obs_dim, self.control_bounds, disableViewer=True)
        ...
        if not self.include_action_in_obs:
            self.net_vf_modules.append([[9, 20], 3, None])
            self.net_vf_modules.append([[8, 19], 3, [0]])
            self.net_vf_modules.append([[7, 18], 3, [1]])
            self.net_vf_modules.append([[6, 17], 3, [2]])
            self.net_vf_modules.append([[5, 16], 3, [3]])
            self.net_vf_modules.append([[4, 15], 3, [4]])
            self.net_vf_modules.append([[3, 14], 3, [5]])
            self.net_vf_modules.append([[2, 13], 3, [6]])
        else:
            self.net_vf_modules.append([[9, 20, 28], 3, None])
            self.net_vf_modules.append([[8, 19, 27], 3, [0]])
            self.net_vf_modules.append([[7, 18, 26], 3, [1]])
            self.net_vf_modules.append([[6, 17, 25], 3, [2]])
            self.net_vf_modules.append([[5, 16, 24], 3, [3]])
            self.net_vf_modules.append([[4, 15, 23], 3, [4]])
            self.net_vf_modules.append([[3, 14, 22], 3, [5]])
            self.net_vf_modules.append([[2, 13, 21], 3, [6]])
        self.net_vf_modules.append([[0, 1, 10, 11, 12], 2, [7]])
        self.net_vf_modules.append([[], 5, [8]])

        # policy modules
        if not self.include_action_in_obs:
            self.net_modules.append([[9, 20], 1, None])
            self.net_modules.append([[8, 19], 1, [0]])
            self.net_modules.append([[7, 18], 1, [1]])
            self.net_modules.append([[6, 17], 1, [2]])
            self.net_modules.append([[5, 16], 1, [3]])
            self.net_modules.append([[4, 15], 1, [4]])
            self.net_modules.append([[3, 14], 1, [5]])
            self.net_modules.append([[2, 13], 1, [6]])
        else:
            self.net_modules.append([[9, 20, 28], 1, None])
            self.net_modules.append([[8, 19, 27], 1, [0]])
            self.net_modules.append([[7, 18, 26], 1, [1]])
            self.net_modules.append([[6, 17, 25], 1, [2]])
            self.net_modules.append([[5, 16, 24], 1, [3]])
            self.net_modules.append([[4, 15, 23], 1, [4]])
            self.net_modules.append([[3, 14, 22], 1, [5]])
            self.net_modules.append([[2, 13, 21], 1, [6]])
        self.net_modules.append([[0, 1, 10, 11, 12], 0, [7]])

        self.net_modules.append([[], 6, [8, 7], None, False])
        self.net_modules.append([[], 6, [8, 6], None, False])
        self.net_modules.append([[], 6, [8, 5], None, False])
        self.net_modules.append([[], 6, [8, 4], None, False])
        self.net_modules.append([[], 6, [8, 3], None, False])
        self.net_modules.append([[], 6, [8, 2], None, False])
        self.net_modules.append([[], 6, [8, 1], None, False])
        self.net_modules.append([[], 6, [8, 0], None, False])
        ...
        self.net_modules.append([[], None, [17, 18, 19, 20, 21, 22, 23, 24], None, False])
